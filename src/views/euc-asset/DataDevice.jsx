...
export default class ITService extends Component {
    ...
    getData = async () => {
        ...
        table.clear().draw();
        const result = await getDocs(collection(db, "data_device"));
        let no = 1;
        result.forEach((doc) => {
            let res = doc.data();
            table.row.add({
    ...
    handleAdd = async (e) => {
        ...
        try {
            await addDoc(collection(db, "data_device"), {
            ...
            this.notify('success', 'Data Device Kantor baru berhasil ditambah');
            this.getData();
            $('#form-add')[0].reset();
            $('.close-add').click();
        } catch (e) {
    ...
    handleEdit = async (e) => {
        ...
        try {
            const result = doc(db, "data_device", data.id_edt);
            ...
            this.notify('success', 'Data Device Kantor berhasil di update');
            this.getData();
    ...
    handleDelete = async (e) => {
        ...
        try {
            ...
            await deleteDoc(doc(db, "data_device", id));

            this.notify('success', 'Data Device Kantor berhasil di hapus');
            this.getData();
            $('.close-del').click();
        } catch (e) {
            console.error("Error adding document: ", e);
    ...
    render() {
        return (
            <div>
                <Layout active="data-device">
                    <div>
                        <ul className="breadcrumb">
                            <li><a href="#!">Home</a></li>
                            <li className="active">Data Device Kantor</li>
                        </ul>
                                ...
                                <div className="col-md-12">
                                    ...
                                    <div className="panel panel-default">
                                        <div className="panel-heading">
                                            <h3 className="panel-title">Data Device Kantor</h3>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title" id="myModalLabel">Tambah Data Device Kantor</h4>
                            </div>
