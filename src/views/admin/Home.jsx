                        ...
                        <div className="row">
                            <div className="col-md-3">
                                ...
                                <div className="widget widget-default widget-carousel">
                                    ...
                                    <div className="widget-controls">
                                        <a href="null" className="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget"><span className="fa fa-times" /></a>
                                    </div>
                                </div>
                                {/* END WIDGET SLIDER */}
                            </div>
                            ...
                            <div className="col-md-3">
                                ...
                                <div className="widget widget-info widget-padding-sm">
                                    ...
                                    <div className="widget-controls">
                                        <a href="null" className="widget-control-right widget-remove" data-toggle="tooltip" data-placement="left" title="Remove Widget"><span className="fa fa-times" /></a>
                                    </div>
                                    <div className="widget-buttons widget-c3">
                                        <div className="col">
                                            <a href="null"><span className="fa fa-clock-o" /></a>
                                        </div>
                                        <div className="col">
                                            <a href="null"><span className="fa fa-bell" /></a>
                                        </div>
                                        <div className="col">
                                            <a href="null"><span className="fa fa-calendar" /></a>
                                        </div>
                                    </div>
                                </div>
                                {/* END WIDGET CLOCK */}
